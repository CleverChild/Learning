package com.example.minseoblim_201621228_final_4;
...
public class Final_4
{
    ...
    private FloatBuffer circle_Buffer1,circle_Buffer2,circle_Buffer3,circle_Buffer4,circle_Buffer5;
    ...
    public Final_4()
    {
        ...
        /// create big ellipse
        float circle1_R1 = 0.39f;
        float circle1_R2 = 1.45f;
        ...
        // create a floating point buffer from the ByteBuffer
        circle_Buffer3 = bb2.asFloatBuffer();
        // add the coordinates to the FloatBuffer
        circle_Buffer3.put(Circle_Coordinate_1);
        // set the buffer to read the first coordinate
        circle_Buffer3.position(0);
        ...
        // create a floating point buffer from the ByteBuffer
        circle_Buffer4 = bb3.asFloatBuffer();
        // add the coordinates to the FloatBuffer
        circle_Buffer4.put(Circle_Coordinate_1);
        // set the buffer to read the first coordinate
        circle_Buffer4.position(0);
        ...
        // create a floating point buffer from the ByteBuffer
        circle_Buffer5 = bb4.asFloatBuffer();
        // add the coordinates to the FloatBuffer
        circle_Buffer5.put(Circle_Coordinate_1);
        // set the buffer to read the first coordinate
        circle_Buffer5.position(0);
    ...
    public void draw(float [] mvpMatrix)
    {
        ...
        Matrix.translateM(mTranslationMatrix,0,0f,-0.69f,0.0f);
        ...
        Matrix.setIdentityM(mTranslationMatrix,0);
        Matrix.translateM(mTranslationMatrix,0,0f,-0.45f,0.0f);
        Matrix.multiplyMM(result_mvpMatrix_Translation,0,mvpMatrix,0,mTranslationMatrix,0);
        GLES20.glUniformMatrix4fv(vPMatrixHandle,1,false,result_mvpMatrix_Translation,0);
        ...
        GLES20.glVertexAttribPointer(positionHandle, COORDS_PER_VERTEX,
                GLES20.GL_FLOAT, false,
                vertexStride, circle_Buffer3);


        Matrix.setIdentityM(mTranslationMatrix,0);
        Matrix.translateM(mTranslationMatrix,0,0.2f,0.25f,0.0f);
        Matrix.multiplyMM(result_mvpMatrix_Translation,0,mvpMatrix,0,mTranslationMatrix,0);
        GLES20.glUniformMatrix4fv(vPMatrixHandle,1,false,result_mvpMatrix_Translation,0);
